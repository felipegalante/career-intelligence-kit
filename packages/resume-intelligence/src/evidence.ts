// Resume evidence graph. Each bullet/line of a resume becomes
...
// walks these instead of treating the resume as one bag of keywords.
...
export interface ResumeEvidence {
  ...
  /** 0–5 — how strong this evidence is. */
